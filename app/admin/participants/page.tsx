...
import { AdminParticipantRowActions } from "@/components/admin-participant-row-actions";
    ...
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-6 px-4 py-6 sm:px-6">
      <header className="rounded-4xl bg-[linear-gradient(135deg,#111827,#1f2937)] px-6 py-7 text-white shadow-lg">
        ...
        <p className="mt-2 max-w-2xl text-sm text-white/75">
          Agregá participantes con una contraseña inicial para que puedan
          entrar.
        </p>
      ...
      <section className="grid gap-5 lg:grid-cols-[1fr_360px]">
        <div className="overflow-hidden rounded-4xl border border-black/10 bg-white shadow-sm">
                  ...
                  >
                    ...
                    <td className="px-4 py-4 align-top">
                      <AdminParticipantRowActions
                        ...
                        statusAction={
                          participant.active
                            ? deactivateParticipantAction.bind(
                                null,
                                participant.id,
                              )
                            : activateParticipantAction.bind(
                                null,
                                participant.id,
                              )
                        }
                        passwordAction={changeParticipantPasswordAction.bind(
                          null,
                          participant.id,
                        )}
                      />
